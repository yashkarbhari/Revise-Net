...
if __name__ == '__main__':
	...
	image_dir = '../SOD/visual_comparison_png/'
	prediction_dir = '../SOD/visual_comparison_pred/'
	model_dir = '../SOD/saved_models_DUTS/200k_testing'
	...
	test_dataloader = DataLoader(test_salobj_dataset, batch_size=1,shuffle=False,num_workers=1)
	
	# --------- 3. model define ---------
	print("...load ReviseNet...")
	net = ReviseNet(3,1)
