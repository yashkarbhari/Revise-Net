...
class ReviseNet(nn.Module):
    def __init__(self,n_channels,n_classes):
        ...
        self.RA1 = RAE(64,512,512)
        self.RA2 = RAE(64,512,512)
        self.RA3 = RAE(64,256,256)
        self.RA4 = RAE(64,128,128)
    ...
    def forward(self,x):
        ...
        rev1 = self.RA1(h1,h5,self.upscore2(hd6))
        hx = rev1
        ...
        rev2 = self.RA2(h1,h4,self.upscore2(hd5))
        hx = rev2
        ...
        rev3 = self.RA3(h1,h3,self.upscore2(hd4))
        hx = rev3
        ...
        rev4 = self.RA4(h1,h2,self.upscore2(hd3))
        hx = rev4
